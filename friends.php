    ...
    <section class="section">
            ...
            <div class="p-2 shadow"> <div>
                  ...
                  <ul id="chatList"
                      ...
                      <?php
                // Inside your PHP loop to display search results
                ...
                <li class="list-group-item">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <img src="profile/<?=$user['profile_image']?>" class="rounded-circle" style="width: 45px!important">
                            <h3 class="fs-6 ms-2 mt-2"><?=$user['name']?></h3>
                        </div>
                        <button class="btn btn-primary" onclick="sendFriendRequest(<?=$user['user_id']?>)">Send Request</button>
                    </div>
                </li>
                <?php
                }
