  ...
  <ul class="d-flex align-items-center">
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
        <img src="profile/<?=$profile_image?>"  class="rounded-circle">
            ...
            <div class="p-2 shadow">
              <a href="home.php" class="fs-4 link-dark">&#8592;</a>
                <div class="d-flex align-items-center">
                    ...
                    <img src="profile/<?= $chatWith['profile_image']?>" class="rounded-circle" style="width: 45px ">
                    <h3  class="display-4 fs-6 m-2"> 
                        ...
                        foreach($chats as $chat){
                            if($chat['from_id'] == $_SESSION['id']) { ?>
                                <p class="rtext align-self-end border rounded p-2 mb-1">
                                    <?=$chat['message']?> <small class="d-block"><?=$chat['created_at']?></small>      	
                                </p>
                            <?php } else { ?>
                ...
                <div class="input-group mb-3">
                    ...
                    <button class="btn btn-primary" id="sendBtn"><i class="ri-send-plane-fill"></i></button>
                </div>
 ...
 <!-- Vendor JS Files -->
    ...
    $(document).ready(function(){
        $("#sendBtn").on('click', function(){
            ...
            // Send message and update last seen timestamp
        ...
        // Call updateLastSeen function every 2 seconds
