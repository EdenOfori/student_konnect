        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="profile/<?=$user['profile_image']?>" alt="Profile" class="rounded-circle">
              <h2><?=$user['name']?></h2>
              <h3>Web Designer</h3>
            </div>
          </div>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?=$user['programme']?></div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="profile/<?=$user['profile_image']?>" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="Department" type="text" class="form-control" id="Department" value="<?=$user['department']?>">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Job" class="col-md-4 col-lg-3 col-form-label">Programme</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="Programme" type="text" class="form-control" id="Programme" value="<?=$user['department']?>">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="Country" class="col-md-4 col-lg-3 col-form-label">University</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="university" type="text" class="form-control" id="university" value="<?=$user['university']?>">
                      </div>
                    </div>
